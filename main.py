...
def delete_cofe(cafe_id):
    api_key = request.args.get("api-key")
    if api_key == "TopSecretAPIKey": #  any other key may be used instead of "TopSecretAPIKey" like : 1982ABCXWY but must be provided in the url when deleting a data
        cafe = db.get_or_404(Cafe, cafe_id)
        if cafe:
